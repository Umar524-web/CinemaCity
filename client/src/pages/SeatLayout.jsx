...
const SeatLayout = () => {
  ...
  return show ? (
    <div className=' flex flex-col md:flex-row px-6 md:px-16 lg:px-40 py-30 md:pt-50'>
      <div className='order-1 w-60 bg-primary/10 border border-primary/20 rounded-lg py-10 h-max md:sticky md:top-30'>
      ...
      <div className='order-2 md:order-2 relative flex-1 flex flex-col items-center max-md:mt-16' >
        ...
        <div className='flex flex-col items-center mt-10 text-xs text-gray-300'>
          ...
          <div className='grid grid-cols-2 gap-11'>
            {groupRows.slice(1).map((groupRows, idx) => (
              <div key={idx}>
